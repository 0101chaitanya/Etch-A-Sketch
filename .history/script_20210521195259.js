...
div1.style.justifyContent = 'space';
let inputX = document.createElement('input');
inputX.style.width = '40px';
inputX.style.height = '30px';
inputX.type = 'number';
/* inputX.style.marginTop = '10px';

inputX.style.marginLeft = '0px';
inputX.style.marginRight = '10px';

inputX.style.marginBottom = '0px';
 */let inputY = document.createElement('input');
inputY.style.width = '40px';
inputY.style.height = '30px';
/* 
inputY.style.marginTop = '10px';

inputY.style.marginLeft = '0px';
inputY.style.marginRight = '10px';

inputY.style.marginBottom = '0px';
 */inputY.type = 'number';
