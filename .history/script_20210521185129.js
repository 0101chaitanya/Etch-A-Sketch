...
house.appendChild(button1);
let button2 = document.createElement('button');
button2.textContent = 'Reset';
house.appendChild(button2);
house.appendChild(inputY);
house.appendChild(inputX);
let NumberX = Number(inputX.value);
let NumberY = Number(inputY.value);
console.log(NumberX, NumberY);
/* if ((isNaN(parseInt(inputX.value)) != true && isNaN(parseInt(inputY.value)) != true)  {
