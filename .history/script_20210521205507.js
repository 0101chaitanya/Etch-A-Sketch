...
NumberX = 64;//Number(inputX.value);
NumberY = 64;//Number(inputY.value);

let go = function (NumberX, NumberY) {

    button1.removeEventListener('click', go, false, { once: true });
...
button1.addEventListener('click', go(NumberX, NumberY), false, { once: true });
button2.addEventListener('click', go(0, 0), false, { once: true });
